...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <div class="col-12">
                    <form action="/attendance/izinsakit" method="get" autocomplete="off">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" name="activity_id" id="activity_id"
                                        class="form-control" placeholder="ID Activity">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('student_name') }}" name="student_name"
                                        id="student_name" class="form-control" placeholder="Nama Mahasiswa">
                                </div>
                            </div>
                            <div class="col-3">
