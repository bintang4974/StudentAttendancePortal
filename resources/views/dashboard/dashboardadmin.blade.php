                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">
                                        {{ $recappermission->amountpermis != null ? $recappermission->amountpermis : 0 }}
                                    </div>
                                    <div class="text-secondary">
                                        Total Izin
                                    </div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">
                                        {{ $recappermission->amountsick != null ? $recappermission->amountsick : 0 }}
                                    </div>
                                    <div class="text-secondary">
                                        Total Sakit
                                    </div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">
                                        {{ $recapAttendance->jmlterlambat != null ? $recapAttendance->jmlterlambat : 0 }}
                                    </div>
                                    <div class="text-secondary">
                                        Total Terlambat
                                    </div>
